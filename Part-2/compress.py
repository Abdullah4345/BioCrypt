...
def compress_file(file_path, output_path, compression_level):
    try:
        compression_type = zipfile.ZIP_DEFLATED  # Only ZIP_DEFLATED supports compression levels
        
        with zipfile.ZipFile(output_path, 'w', compression=compression_type, compresslevel=compression_level) as zipf:
